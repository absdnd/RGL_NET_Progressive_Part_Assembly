...
class Network(nn.Module):
    ...
    def forward(self, conf, relation_matrix, part_valids, part_pcs, instance_label, class_list):
        ...
        # Batch_size and num_part and relation_matrix.
        ...
        for iter_ind in range(self.conf.iter):
            ...
            if iter_ind >= 1 :
                ...
                # pose_featA and pose_featB can be used to identify a relation between parts.
                ...
                # relation_matrix is being obtained using this.
                # new_relation quantifies the relation between the parts, 
                # valid_matrix says whether we can have a relation or not. 
                relation_matrix = new_relation.double() * valid_matrix
                total_pred_relations.append(relation_matrix)

            # iter_ind >= 1 and iter_ind%2 == 1.
            ...
            # part_relation_matrix is being computed. 
    ...
    # Contact points between selected elements. 
    def get_possible_point_list(self, point, sym):
        # sym is torch.tensor([1.0, 1.0, 1.0])
    ...
    def get_min_l2_dist(self, list1, list2, center1, center2, quat1, quat2):
        ...
        # List1 and List2 is being obtained. 
        list1 = list1.to(self.conf.device)
        list2 = list2.to(self.conf.device)

        # Rotate the points with quat1 and obtain a new set of points. 
        list1 = center1 + qrot(quat1, list1)
        list2 = center2 + qrot(quat2, list2)

        # Rotate and translate these points using quat1 and center1, and quat2, and center2.
    ...
    def get_contact_point_loss(self, center, quat, contact_points, sym_info):
        # batch_size and num_parts being identified. 
        batch_size = center.shape[0]
        num_part = center.shape[1]

        # Contact point loss, torch.zeros(batch_size)
